 ...
 * @see java.awt.eventActionListener
...
public class EasyDifGameFrame extends JFrame {
	...
	private Card card1;
	private Card card2;
	private EasyDifGamePanel gamePanel;
    ...
    public EasyDifGameFrame(ImageCategory category){
    	...
    	this.gamePanel = new EasyDifGamePanel(category);
    	setConfirmButtonProperties();
    	setFrameProperties();
    }
    
    public EasyDifGameFrame(boolean loggedIn, String username, ImageCategory category){
    	this.category = category;
    	this.username = username;
    	this.loggedIn = loggedIn;
    	this.gamePanel = new EasyDifGamePanel(this.category);
    	setConfirmButtonProperties();
    	setFrameProperties();
    }
    	...
    	confBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(completed) { 
					...
					if(loggedIn) {
						new PointSaving(username, tentativi, "Easy");
					}else {
						new PointSaving("guest", tentativi, "Easy");
					}
